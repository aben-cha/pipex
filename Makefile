...
SRC = mandatory/pipex.c mandatory/ft_split.c mandatory/gnl_utils.c mandatory/functions_utils.c \
	mandatory/check_errors.c

SRC_BONUS = bonus/pipex_bonus.c bonus/functions_utils_bonus.c bonus/chech_errors_bonus.c \
